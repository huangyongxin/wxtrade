...
<head>
    ...
    <!-- icon for web -->
    <link rel="icon" type="image/png" href="<?php echo base_url("public/assets/images/logo180.png") ?>" >
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo base_url("public/bower_components/AdminLTE/dist/css/AdminLTE.min.css") ?>" >
    <!-- AdminLTE Skins. Choose a skin from the css/skins
    folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?php echo base_url("public/bower_components/AdminLTE/dist/css/skins/_all-skins.min.css") ?>" >
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo base_url("public/bower_components/AdminLTE/dist/js/app.min.js") ?>" ></script>
    <!-- 引入 Vue -->
